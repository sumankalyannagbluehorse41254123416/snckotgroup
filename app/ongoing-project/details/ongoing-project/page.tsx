        ...
        <div className="container">
          ...
          <div className="row">
            <div className="container">
              <div className="tab tabbtn">
                <div className="phTabs">
                  <ul className="phdoor">{/* Future dynamic tabs */}</ul>
                </div>
              </div>
              <div className="phMatr">{/* Dynamic future content */}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="videoFrame">
                <Image
                  src={sections[1]?.image || "/images/No_Image_Available.jpg"}
                  alt={sections[1]?.title || "Main gallery image"}
                  width={600}
                  height={400}
            ...
            <div className="col-md-6">
              <ul className="pgalImages">
                <li>
                  <Image
                    src={
                      subsections1?.[0]?.image ||
                      "/images/No_Image_Available.jpg"
                    }
                    alt={subsections1?.[0]?.title || "Gallery image 1"}
                    width={300}
                    height={200}
                    style={{ objectFit: "cover" }}
                  />
                ...
                <li>
                  <Image
                    src={
                      subsections1?.[1]?.image ||
                      "/images/No_Image_Available.jpg"
                    }
                    alt={subsections1?.[1]?.title || "Gallery image 2"}
                    width={300}
                    height={200}
                    style={{ objectFit: "cover" }}
                  />
